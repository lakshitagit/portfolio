...
const Welcome = () => {
    ...
    const subtitleRef = useRef(null); //use these to intract with actual elemetns
    useGSAP(()=>{
  ...
  return (
   <section id="welcome">
    <p ref={subtitleRef}>{renderText("Hey, I am Lakshita! Welcome to my",'text-3xl font-georama',100)} </p>
